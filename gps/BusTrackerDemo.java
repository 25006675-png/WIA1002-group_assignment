...
public class BusTrackerDemo {
    ...
    public BusTrackerDemo() {
        this.simulator = SampleDataFactory.createCampusShuttleSimulator();
    ...
    public void show() {
        JFrame frame = new JFrame("GPS Bus Tracker Demo");
    ...
    private void updateLabels() {
        ...
        if (status.isTripCompleted()) {
            statusValue.setText("Trip completed");
        } else {
            statusValue.setText(
                    "Bus " + status.getBusId()
                            + " will arrive at "
